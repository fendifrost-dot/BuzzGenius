...
const RecurringRevenue = () => (
  <SectionContainer id="partnerships">
    <p className="mb-3 text-xs font-medium uppercase tracking-[0.2em] text-brand-blue">Recurring Revenue</p>
    ...
    <p className="mb-6 max-w-3xl text-muted-foreground leading-relaxed">
      Many Buzz Genius execution clients operate on recurring monthly service agreements for continued marketing, automation, creative production, and operational support.
    </p>
    <p className="mb-10 max-w-3xl text-muted-foreground leading-relaxed">
      Monthly retainers allow businesses to maintain momentum while providing scalable long-term support. Consulting engagements remain typically short-term per our Pricing Structure.
    </p>
    <div className="grid gap-4 sm:grid-cols-2">
      {highlights.map(({ icon: Icon, label }) => (
        <div key={label} className="flex items-start gap-4 rounded-lg border border-border bg-card p-5 shadow-sm">
