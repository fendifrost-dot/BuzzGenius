    ...
    <section className="bg-matte-dark text-primary-foreground">
      <div className="container mx-auto max-w-6xl px-6 py-24 md:py-32">
        <motion.div
          ...
          className="max-w-3xl"
        >
          <p className="mb-4 text-xs font-medium uppercase tracking-[0.2em] text-brand-blue">
            Growth Infrastructure
          </p>
          <h1 className="mb-6 text-4xl font-bold tracking-tight text-primary-foreground md:text-5xl lg:text-6xl">
            Growth Infrastructure for Modern Brands
          </h1>
          <p className="mb-10 max-w-2xl text-base font-light leading-relaxed text-chrome-light md:text-lg">
            Buzz Genius provides integrated marketing, media production, automation, branding, and
            AI-powered growth systems for businesses, creators, and organizations.
          </p>
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-brand-silver/40 bg-transparent text-primary-foreground hover:bg-white/10"
        ...
        >
          {trustIndicators.map((item) => (
            <li key={item} className="flex items-center gap-2 text-sm text-chrome-light">
