    ...
    <section className="bg-matte-dark text-primary-foreground">
      <div className="container mx-auto max-w-6xl px-6 py-24 md:py-32">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="max-w-3xl">
          <p className="mb-4 text-xs font-medium uppercase tracking-[0.2em] text-brand-blue">Consulting &amp; Strategic Advisory · Marketing &amp; Growth Execution</p>
          <h1 className="mb-6 text-4xl font-bold tracking-tight text-primary-foreground md:text-5xl lg:text-6xl">
            Advisory and Execution for Growth-Stage Operators
          </h1>
          <p className="mb-10 max-w-2xl text-base font-light leading-relaxed text-chrome-light md:text-lg">
            Structured consulting packages from $1,000 to $6,000, plus marketing, AI automation,
            content, and creative execution delivered through project work and monthly retainers.
          </p>
          <div className="flex flex-col gap-3 sm:flex-row">
            <Button size="lg" className="bg-brand-blue text-white hover:bg-brand-blue/90" onClick={() => scrollTo("consulting-advisory")}>
              View Consulting Packages
              <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
            <Button size="lg" variant="outline" className="border-brand-silver/40 bg-transparent text-primary-foreground hover:bg-white/10" onClick={() => scrollTo("services")}>
